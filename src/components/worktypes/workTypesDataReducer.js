...
import axiosInstance from '../authentication/axiosApi';


export const fetchWorkTypes = createAsyncThunk('workTypes/fetchAll', async () => {
  const response = await axiosInstance.get('/wpm/api/worktypes/')
  return response.data
})

export const updateWorkType = createAsyncThunk('worktypes/updateOne', async arg => {
