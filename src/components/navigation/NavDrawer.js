...
import {
	...
	fetchCurrentApplication, submitApplicationData,
...
const NavDrawer = (props) => {
	...
	const applicationSubmissionDetail = useSelector(state => state.applicationDetail)
	...
	const submitApplication = () => {
		confirm({
			...
			.then(() => dispatch(submitApplicationData({
