		...
		crudButtons: [
			{
				component: (
					<GreenButton
						type="button"
						onClick={ handleOpenCreate("instruction-modal", "instructionForm", "CREATE WORK INSTRUCTION") }
						fullWidth
					>
						CREATE INSTRUCTION
					</GreenButton>
			...
			},
			{
				component: (
					<PurpleButton
						type="button"
						fullWidth
						onClick={ handleViewOnly("instruction-modal", "documentsList", "VIEW DOCUMENTS") }
					>
						VIEW DOCUMENTS
					</PurpleButton>
				),
			},
			{
				component: (
					<PurpleButton
						...
						onClick={
							handleViewOnly("instruction-modal", "locationImages", "LOCATION IMAGES")
						}
					>
						VIEW ALL IMAGES
					</PurpleButton>
