...
const NavDrawer = (props) => {
    ...
    const handleViewOnly = (name, content) => () => {
        dispatch(show(name, {title: "VIEW DOCUMENTS", content: content}));
    };
    ...
    const instructionBarButtons = {
        crudButtons: [
            ...
            {
                component: (
                    <RedButton type="button" onClick={handleDeleteRow}>
                        DELETE INSTRUCTION
                    </RedButton>
                ),
            },
        ...
        navButtons: [
            {
                component: (
                    <PurpleButton type="button" onClick={handleViewSummary}>
        ...
        crudButtons: [
            {
                component: (
                    <GreenButton
                        type="button"
                        onClick={handleOpenCreate("instruction-modal")}
                        fullWidth
                    >
                        CREATE LOCATION
                    </GreenButton>
            ...
            },
            {
                component: (
                    <GreenButton
                        type="button"
                        onClick={handleOpenEdit("instruction-modal")}
                        fullWidth
                    >
                        EDIT LOCATION
                    </GreenButton>
            ...
            {
                component: (
                    <RedButton type="button" onClick={handleDeleteRow} fullWidth>
                        DELETE LOCATION
                    </RedButton>
                ),
            },
    ...
    const itemDetailsBarButtons = {
        crudButtons: [
            ...
            {
                component: (
                    <RedButton type="button" fullWidth onClick={handleDeleteRow}>
                        DELETE BILL ITEM
                    </RedButton>
                ),
            },
