...
const NavDrawer = (props) => {
    ...
    const atLocations = location.pathname.startsWith("/work-instructions/locations/summary/");
    ...
    const instructionButtonCrudList = [
        {
            component: (
                <GreenButton onClick={handleOpenCreate("instruction-modal", "instructionForm")}>
                    CREATE INSTRUCTION
                </GreenButton>
            ),
        },
        {
            component: (
                <GreenButton onClick={handleOpenEdit("instruction-modal", "instructionForm")}>
                    EDIT INSTRUCTION
                </GreenButton>
            ),
        },
    ...
    const locationButtonList = [
        ...
        {
            component: (
                <RedButton onClick={handleDeleteRow} fullWidth>DELETE LOCATION</RedButton>
            ),
        },
    ];
    ...
    const locationsViewList = [{
        component: (
            <PurpleButton fullWidth>VIEW ITEMS</PurpleButton>
        )
    },
        {
            component: (
                <PurpleButton fullWidth>VIEW DOCUMENTS</PurpleButton>
            )
        },
        {
            component: (
                <PurpleButton fullWidth>VIEW IMAGES</PurpleButton>
            )
        }
    ]
    ...
    const locationsUpdateList = [{
         component: (
            <GreenButton fullWidth>UPDATE WORK PROGRESS</GreenButton>
        )
    },
        {
            component: (
                <GreenButton fullWidth>UPLOAD IMAGE</GreenButton>
            )
        },
        {
            component: (
                <GreenButton fullWidth>UPLOAD DOCUMENT</GreenButton>
            )
    }]
