...
import {selectAllAvailableWorksheets, selectAllRecentWorksheets} from "./data/WorksheetData";
...
const applicationDetail = state => state.applicationDetail

export const submissionAvailable = createSelector (
    [applicationDetail],
    (detail) => {
        return detail.header && !!(detail['header'].app_submitted || detail['header'].app_open);
    },
);
